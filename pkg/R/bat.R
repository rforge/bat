...
#' @param runs Number of resampling runs for rarefaction. If not specified, default is 1000.
...
#' @param runs Number of random permutations to be made to the sample order. If not specified, default is 1000.
